...
%-------------------------------------------------------------------------
% Fix PDF version compatibility for including Front/main.pdf
\pdfminorversion=7

% Include pdf pages in the document
% Necessary to include the front pages (cover and etc.)
\usepackage{pdfpages}
\usepackage{tikz} % For adding overlay links on included PDFs
...
\newacronym{senet}{SE-Net}{Squeeze-and-Excitation Network}
