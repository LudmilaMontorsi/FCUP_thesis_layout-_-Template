...
Due to the fact that artifacts in\acrshort{ct} can hide or simulate pathologies \cite{boasCTArtifactsCauses2012}, its presence can compromise the diagnostic quality and clinical reliability of images. A diagnostic mistake can have serious consequences for the patient, including treatment delays, inadequate or unnecessary treatments, and even life-threatening risks \cite{alkhodariEnhancingCCTAImage2025}. Additionally, artifacts can degrade an image to the point of making it unusable for diagnosis, in which case the scan may need to be repeated, exposing the patient to further radiation. When the artifact instead obscures nearby soft tissue rather than making the whole image unusable, it can still lead to an incorrect diagnosis or, in radiotherapy planning, an incorrect radiation dose calculation \cite{alzainCommonComputedTomography2021}. The constant technological evolution has made the use of metallic implants increasingly common in the medical context, which significantly increases the presence of this type of artifact and also the associated diagnostic mistakes \cite{kleberAdvancementsSupervisedDeep2024}. 
