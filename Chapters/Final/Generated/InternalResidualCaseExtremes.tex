\begin{figure}[!htbp]
\centering
\includegraphics[width=0.90\linewidth]{Figures/Generated/evaluation_final/Residuals/residual_greatest_structural_improvement_01_s1250.pdf}
\medskip
\includegraphics[width=0.90\linewidth]{Figures/Generated/evaluation_final/Residuals/visualization_greatest_structural_improvement_01_s1250.pdf}
\captionsetup{skip=2pt}
\caption[Greatest Artifact-ROI $\Delta$SSIM: head\_1147]{Residual map (top) and reconstruction visualization (bottom) for case head\_1147 (test-set index 1250), selected among the three highest artifact-ROI $\Delta$SSIM values ($\Delta\mathrm{SSIM}_{\mathrm{ROI}}=+0.7220$; global $\Delta\mathrm{SSIM}=+0.1649$; $\Delta\mathrm{PSNR}=+15.99$~dB). All error maps are restricted to the body mask.}
