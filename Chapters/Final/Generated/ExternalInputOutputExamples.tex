...
\caption[Illustrative external cases by input-output SSIM]{Descriptive external cases with the highest and lowest input--output SSIM values.\tablecaptionnote{Cases were selected only by the extremes of SSIM(Input, Output). High SSIM denotes less structural change between input and output; this ranking does not define artifact-removal quality or clinical acceptability.}}
