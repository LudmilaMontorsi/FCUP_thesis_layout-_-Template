...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.84\linewidth]{Figures/Generated/external_evaluation/external_least_structurally_changed.pdf}
\captionsetup{skip=2pt}
\caption[Least structurally changed external cases]{External input-output pairs with the three highest SSIM values, representing the least structural change. The soft-tissue window is identical for input and output within each case.}
\label{fig:external-least-structurally-changed}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.84\linewidth]{Figures/Generated/external_evaluation/external_most_structurally_changed.pdf}
\captionsetup{skip=2pt}
\caption[Most structurally changed external cases]{External input-output pairs with the three lowest SSIM values, representing the greatest structural change. The soft-tissue window is identical for input and output within each case.}
