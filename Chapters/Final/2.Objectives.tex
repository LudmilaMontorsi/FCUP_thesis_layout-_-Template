...
This chapter defines the scope of the dissertation and the criteria used to evaluate its main claims. It presents the general and specific objectives, followed by the pre-specified hypotheses, outcome hierarchy, and interpretation boundaries for internal and external evaluation.

\section{General Objective}

The general objective of this dissertation is to develop, evaluate and rigorously compare a\acrshort{cnn} model for metal artifact reduction in\acrshort{ct}, prioritizing anatomical preservation, robustness to domain variation and interpretability of the correction process. Additionally, the study aims to investigate the generalization of the best performing model to real and external data, with a focus on clinical applicability. Healthcare professionals was involved in the evaluation of the model's performance on real data, providing a comprehensive assessment of its effectiveness and potential for clinical use.

\section{Specific Objectives}
The specific objectives of this study include:

\begin{itemize}
    \item Develop a reproducible pipeline for training and evaluating metal artifact reduction models in\acrshort{ct} in the image domain.
