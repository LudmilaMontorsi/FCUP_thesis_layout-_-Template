...
\caption[Validation MAE at best validation SSIM]{MAE de validação na época selecionada pelo melhor SSIM de validação, por modelo e seed. No Dual Model, ambas as métricas são calculadas na saída de reconstrução de imagem.}
