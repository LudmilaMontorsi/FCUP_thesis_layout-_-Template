...
\begin{minipage}[b][297mm][t]{125mm}
	...
	\parbox[b][200mm][c]{125mm}{
		...
		{\HUGE \bfseries U-NET for Metal Artifact Reduction} \\
		{\HUGE \bfseries in Computed Tomography} \\
		...
		\parbox[b][120mm][b]{120mm}
		{
			...
			\begin{minipage}[b][120mm][t]{80mm}
				...
				\parbox[b][95mm][c]{80mm}{
					\raggedright
					\setstretch{\ttlspcCD}
					{\LargeB \bfseries U-NET for Metal Artifact Reduction} \\
					{\largeB \bfseries in Computed Tomography} \\
