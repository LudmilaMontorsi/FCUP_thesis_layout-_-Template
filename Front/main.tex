...
\hypersetup{colorlinks,linkcolor=darkblue,urlcolor=darkblue,citecolor=darkblue}
...
\begin{minipage}[b][297mm][t]{125mm}
	...
	\parbox[b][200mm][c]{125mm}{
		...
		{\HUGE \bfseries for Metal Artifact} \\
		{\HUGE \bfseries Reduction in} \\
		{\HUGE \bfseries Computed Tomography} \\
		\setstretch{1.2} {\large~\\}
		{\LargeA \authr \\}
		{\large \degree \\}
		{\small \deptname \\ \facname \\ \the\year \\}
		{\small~\\}
		\ifdefined\supaffilnolink
		...
		\parbox[b][120mm][b]{120mm}
		{
			...
			\begin{minipage}[b][120mm][t]{80mm}
				...
				\parbox[b][95mm][c]{80mm}{
					\raggedright
					\setstretch{\ttlspcCD}
					{\LargeB \bfseries Deep Learning} \\
					{\LargeB \bfseries for Metal Artifact} \\
					{\LargeB \bfseries Reduction in} \\
					{\largeB \bfseries Computed Tomography} \\
